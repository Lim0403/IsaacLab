        ...
        with torch.inference_mode():
            ...
            if not eval_done:
                ...
                if env_done_value:
                    ...
                    # Treat env-side done as success only if Pt satisfies the success threshold.
                    # This prevents timeout-like episodes with Pt < threshold from being counted as success.
                    if (not is_env_oob) and (row["pt"] >= float(env_unwrapped.cfg.success_pt_threshold)):
