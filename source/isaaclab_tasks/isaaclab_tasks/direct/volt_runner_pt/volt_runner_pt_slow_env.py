...
@configclass
class VoltRunnerPtSlowEnvCfg(DirectRLEnvCfg):
...
class VoltRunnerPtSlowEnv(DirectRLEnv):
    cfg: VoltRunnerPtSlowEnvCfg

    def __init__(self, cfg: VoltRunnerPtSlowEnvCfg, render_mode: str | None = None, **kwargs):
