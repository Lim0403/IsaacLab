...
@configclass
class VoltRunnerPtAlignSlowEnvCfg(DirectRLEnvCfg):
...
class VoltRunnerPtAlignSlowEnv(DirectRLEnv):
    cfg: VoltRunnerPtAlignSlowEnvCfg

    def __init__(self, cfg: VoltRunnerPtAlignSlowEnvCfg, render_mode: str | None = None, **kwargs):
